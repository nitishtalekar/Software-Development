...
<body>
  ...
  <div class="container">
    ...
    <div class="row align-items-center my-5">
      ...
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <h1 class="font-weight-light">Professors of RGIT</h1>
        ...
        <div class="card h-100">
          ...
          <form class="contact100-form validate-form" action="index.php" method="POST" enctype="multipart/form-data">
            <div class="wrap-input100 validate-input bg1 mx-3 my-3" data-validate="Please Fill Field">
    					<span class="label-input100">PROFESSOR - ID:</span>
    					<input class="input100" type="text" name="tnpno" placeholder="Enter PROFESSOR Id">
    				</div>
            <div class="wrap-input100 validate-input bg1 mx-3 my-3" data-validate="Please Fill Field">
