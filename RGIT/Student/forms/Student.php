...
if (!isset($_SESSION['pre_userid']) && !isset($_SESSION['userid'])) {

	header('location: /RGIT/Student');
}

if (isset($_SESSION['pre_userid'])) {
	unset($_SESSION['userid']);
	$grno = $_SESSION['pre_userid'];
...
if (isset($_POST['student_info'])) {
	...
	if ($exist == 0) {
		if ($pwd == $pwd2) {
			$query = "INSERT INTO student(grno, student_name, password, student_mail, student_phone, student_gen, student_dob, tenth_board, tenth_percent, twelfth_board, twelfth_percent, student_doj, student_dept, student_sem, eng_percentage, active_kt, gap) VALUES ('$grno','$name','$pwd','$email','$phone','$gen','$dob','$tenbrd','$tenper','$twelvebrd','$twelveper','$doj','$dept','$sem','$ep','$ak','$gap')";
		...
		$query = "UPDATE student SET student_name='$name',student_mail='$email',student_phone='$phone',student_gen='$gen',student_dob='$dob',tenth_board='$tenbrd',tenth_percent='$tenper',twelfth_board='$twelvebrd',twelfth_percent='$twelveper',student_doj='$doj',student_dept='$dept',student_sem='$sem',eng_percentage='$ep',active_kt='$ak',gap='$gap' WHERE grno='$grno';";
		mysqli_query($db, $query);
	}
	$_SESSION['userid'] = $grno;
	$_SESSION['Name'] = $name;
	if ($_SESSION['exist'] == 1) {
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="Student.php" method="POST" enctype="multipart/form-data">
				...
				<div class="wrap-input100 bg1 validate-input rs2-wrap-input100" data-validate="Please Fill Field">
					...
					<input class="input100" type="text" name="fname" value="<?= $sfname ?>" placeholder="First Name" required>
				</div>

				<div class="wrap-input100 bg1 validate-input rs2-wrap-input100" data-validate="Please Fill Field">
					<span class="label-input100">Middle Name</span>
					<input class="input100" type="text" name="mname" value="<?= $smname ?>" placeholder="Middle Name" required>
				</div>

				<div class="wrap-input100 bg1 validate-input rs2-wrap-input100" data-validate="Please Fill Field">
					<span class="label-input100">Last Name</span>
					<input class="input100" type="text" name="lname" value="<?= $slname ?>" placeholder="Last Name" required>
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Please Fill Field">
					<span class="label-input100">Password</span>
					<input class="input100" type="password" name="pwd" value="<?= $spwd ?>" placeholder="Enter Your Password " required>
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Please Fill Field">
					<span class="label-input100">Comfirm Password</span>
					<input class="input100" type="password" name="pwd2" value="<?= $spwd ?>" placeholder="Re-Enter Your Password " required>
				</div>

				<!-- CONTACT -->
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Please Fill Field">
					<span class="label-input100">Email ID</span>
					<input class="input100" type="text" name="email" value="<?= $semail ?>" placeholder="Enter Your Email " required>
				</div>

				<div class="wrap-input100 bg1 validate-input rs1-wrap-input100" data-validate="Please Fill Field">
					<span class="label-input100">Phone Number</span>
					<input class="input100" type="text" name="phone" value="<?= $sphone ?>" placeholder="Enter Phone Number" required>
				</div>
				...
				<div class="wrap-input100 bg1 validate-input rs1-wrap-input100" data-validate="Please Fill Field">
					...
					<input class="input100" type="text" value="<?= $stenper ?>" name="tenpercent" placeholder="%" required>
				</div>
				...
				<div class="wrap-input100 input100-select bg1 rs1-wrap-input100">
					...
					<div>
						<select class="js-select2" name="twelveboard" required>
				...
				<div class="wrap-input100 bg1 validate-input rs1-wrap-input100" data-validate="Please Fill Field">
					<span class="label-input100">Percentage</span>
					<input class="input100" type="text" value="<?= $stwelveper ?>" name="twelvepercent" placeholder="%" required>
				</div>
				...
				<div class="wrap-input100 bg1 validate-input rs1-wrap-input100">
					<span class="label-input100">Engineering Average Percentage till the date</span>
					<input class="input100" type="text" value="<?= $ep ?>" name="eng_percentage" placeholder="%" required>
				</div>

				<div class="wrap-input100 bg1 validate-input rs1-wrap-input100">
					<span class="label-input100">Active KT's</span>
					<input class="input100" type="text" value="<?= $ak ?>" name="active_kt" placeholder="" required>
				</div>

				<div class="wrap-input100 bg1 validate-input rs1-wrap-input100">
					<span class="label-input100">Count of gap</span>
					<input class="input100" type="text" value="<?= $gap ?>" name="gap" placeholder="" required>
				</div>
