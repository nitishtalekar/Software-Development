...
<body>
  ...
  <div class="container">
    ...
    <div class="row align-items-center my-5">
      ...
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <h1 class="font-weight-light">Training and Placement Office</h1>
        ...
        <div class="card h-100">
          ...
          <form class="contact100-form validate-form" action="../authenticate.php" method="POST" enctype="multipart/form-data">
            <div class="wrap-input100 validate-input bg1 mx-3 my-3" data-validate="Please Fill Field">
              ...
              <input class="input100" type="text" name="id" placeholder="Enter TPO Id">
            </div>
            <div class="wrap-input100 validate-input bg1 mx-3 my-3" data-validate="Please Fill Field">
            ...
            <div class="container-contact100-form-btn mx-2 my-2">
              <button type="submit" class="contact100-form-btn" name="button">
                <span>
                  Login
