            ...
            <tr <?php
              ...
              <?php if (!$student_selected_bool) {
                ...
                <td <?php
                        ...
                        ?>>
                  <form method="post" action="/RGIT/TPO/select_reject.php" onsubmit="return confirm('Are you sure you want to select <?php echo ($row['student_grno']); ?> ?');">
                ...
                <?php
                    if (!$student_rejected_bool) {
                      ?>
                  <td>
                    <form method="post" action="/RGIT/TPO/select_reject.php" onsubmit="return confirm('Are you sure you want to reject <?php echo ($row['student_grno']); ?> ?');">
                      <input type="number" name="grno" value="<?php echo ($row['student_grno']); ?>" hidden>
