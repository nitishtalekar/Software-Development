...
<body>
  ...
  <div class="container">
    ...
    <div class="row align-items-center my-5">
      <div class="col-lg-7">
        <img class="img-fluid rounded mb-4 mb-lg-0" src="../image/RGIT.jpg" alt="">
      </div>
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <h1 class="font-weight-light">Welcome RGIT Professor</h1>
    ...
    <div class="row">
      <div class="col-md-12 mb-5">
        <div class="card h-100">
          <div class="card-body">
            <h2 class="card-title">Login as Professor</h2>
          ...
          <form class="contact100-form validate-form" action="../authenticate.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="container-contact100-form-btn mx-2 my-2">
    					<button type="submit" class="contact100-form-btn" name="teacher_id">
    						<span>
    							Login
