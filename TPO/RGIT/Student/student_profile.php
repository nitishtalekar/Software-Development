    ...
    <div class="row">
      <div class="col-md-4 mb-5">
        <div class="card h-100">
          <div class="card-body">
            <h2 class="card-title">Applied Companies</h2>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem magni quas ex numquam, maxime minus quam molestias corporis quod, ea minima accusamus.</p>
          </div>
          <form class="contact100-form validate-form" action="applied_companies.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="col-md-4 mb-5">
        <div class="card h-100">
          ...
          <form class="contact100-form validate-form" action="available_companies.php" method="POST" enctype="multipart/form-data">
            <div class="container-contact100-form-btn mx-2 my-2">
