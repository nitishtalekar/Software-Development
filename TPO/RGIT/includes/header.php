...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  <div class="container">
    <a class="navbar-brand" href="/RGIT/Student/profile.php">Hi!! <?php echo (ucwords($username)) ?></a>
    <span style="color:white"><?php if ($old_salary > 0) {
                                echo (" You are placed in " . $placed_company_name . " With salary " . $old_salary);
                              } ?></span>
