...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2019 at 06:45 AM
...
(3, 'Facebook', 'a', 50, 1200000, 50, 50, 50, 50, 50, 0, 0);
...
('3', 'shano', 'a', 'thatsnice@gmail.com', '9878555', 'M', '2019-08-05', 'ssc', 78, 'hsc', 74, '2019-08-04', 'comps', 7);
...
--
ALTER TABLE `applied_student`
  MODIFY `applied_company_id` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
